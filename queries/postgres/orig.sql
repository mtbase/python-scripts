-- set max_parallel_degree = 8; --8--16
-- \timing
-- ##### CHECKING CONFIG ######
...
---- Q15 -- Create View -- uses parallalization
...
---- Q15 -- Query -- uses parallalization
